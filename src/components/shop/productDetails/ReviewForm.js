...
const ReviewForm = (props) => {
    ...
    const ratingUserList = data.singleProductDetail.pRatingsReviews.map(
        (item) => {
            return item.user ? item.user.user_id : ''
        }
    )
    ...
    return (
        <Fragment>
            ...
            {ratingUserList.includes(isAuthenticate().user.user_id) ? (
                ...
                <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 flex flex-col">
                    ...
                    <div className="mb-4">
                        <fieldset
                            onChange={(e) =>
                                setFdata({ ...fData, rating: e.target.value })
                            }
                            className="rating"
                        >
                            <input
                    ...
                    <div className="space-y-4">
                        ...
                        <div
                            onClick={(e) =>
                                reviewSubmitHanlder(fData, setFdata, fetchData)
                            }
