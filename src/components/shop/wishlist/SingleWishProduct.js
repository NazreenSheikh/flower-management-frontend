                ...
                {products.length > 0 ? (
                    products.map((product, index) => {
                        return (
                            <div
                                key={index}
                                className="relative col-span-1 m-2 md:py-6 md:border-t md:border-b md:my-2 md:mx-0 md:flex md:items-center md:justify-between"
                            >
                                ...
                                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                                    ...
                                    {product.pQuantity > 0 ? (
                                        <div className="my-1 text-green-500 md:my-0">
                                            In Stock
                                        </div>
                                    ) : (
                                        <div className="my-1 text-red-500 md:my-0">
                                            Out Stock
                                        </div>
                                    )}
                                    ...
                                    <div
                                        ...
                                        className="inline-block px-4 py-2 text-xs text-center text-white cursor-pointer md:text-base hover:opacity-75"
                                    >
                                        View
                                    </div>
                                </div>
    ...
    return (
        <Fragment>
            <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
                <div className="mx-2 mb-6 text-2xl">Wishlist</div>
                {/* Product List */}
                <Product />
            </section>
        </Fragment>
